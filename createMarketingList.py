...
infile = open('marketinglist.csv', 'r')
...
outfile = open('marketinglistFINAL.csv', 'a')
...
for row in reader:
    ...
    #mkt_dict['name'] = row[0]
   # mkt_dict['Email'] = row[1]
    #mkt_dict['Phone'] = row[2] 

    mkt_dict = {row[0]:'email: ' + row[1] + ' phone: ' + row[2] for row in reader}
